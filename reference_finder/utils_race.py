...
class RaceExample(object):
    """
    A single training/test example for the RACE dataset(for each question of context).
    """
    def __init__(self,
                 question_id,
                 doc_tokens,
        ...
        self.simple_question_text = simple_question_text
...
def read_race_examples(input_file):
    """Read a RACE json file into a list of RACE Example."""
    ...
    for entry in input_data:
        ...
        question_text = remove_quotation(entry["question"])
        answer_text = remove_quotation(entry["answer"])
        ...
        example = RaceExample(
            ...
            reference_context="",
            simple_question_text=remove_quotation(entry["question"])
        )
