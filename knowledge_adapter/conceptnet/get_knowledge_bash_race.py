...
def generate_bash():
    with open("train_m0.sh", 'w') as f:
        for i in range(0, 25):
            f.write("python get_knowledge.py train_middle %d &\n" % i)
        f.write('wait')
    ...
    with open("train_h0.sh", 'w') as f:
        for i in range(0, 25):
            f.write("python get_knowledge.py train_high %d &\n" % i)
        f.write('wait')
    ...
    with open("dev_m0.sh", 'w') as f:
        for i in range(0, 25):
            f.write("python get_knowledge.py dev_middle %d &\n" % i)
        f.write('wait')
    ...
    with open("dev_h0.sh", 'w') as f:
        for i in range(0, 25):
            f.write("python get_knowledge.py dev_high %d &\n" % i)
        f.write('wait')
    ...
    with open("test_m0.sh", 'w') as f:
        for i in range(0, 25):
            f.write("python get_knowledge.py test_middle %d &\n" % i)
        f.write('wait')
    ...
    with open("test_h0.sh", 'w') as f:
        for i in range(0, 25):
            f.write("python get_knowledge.py test_high %d &\n" % i)
        f.write('wait')
