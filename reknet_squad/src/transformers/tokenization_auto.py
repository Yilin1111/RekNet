...
if is_tokenizers_available():
    ...
    DPRQuestionEncoderTokenizer = None
    ElectraTokenizer = None
    FunnelTokenizer = None
    GPT2Tokenizer = None
    LayoutLMTokenizer = None
    LongformerTokenizer = None
    LxmertTokenizer = None
    MBartTokenizer = None
    MobileBertTokenizer = None
    OpenAIGPTTokenizer = None
    PegasusTokenizer = None
    ReformerTokenizer = None
    RetriBertTokenizer = None
    RobertaTokenizer = None
    SqueezeBertTokenizer = None
    T5Tokenizer = None
    XLMRobertaTokenizer = None
    XLNetTokenizer = None
...
TOKENIZER_MAPPING = OrderedDict(
    [
        (RetriBertConfig, (RetriBertTokenizer, RetriBertTokenizer)),
        (T5Config, (T5Tokenizer, T5Tokenizer)),
        (MobileBertConfig, (MobileBertTokenizer, MobileBertTokenizer)),
        (DistilBertConfig, (DistilBertTokenizer, DistilBertTokenizer)),
        (AlbertConfig, (AlbertTokenizer, AlbertTokenizer)),
        (CamembertConfig, (CamembertTokenizer, CamembertTokenizer)),
        (PegasusConfig, (PegasusTokenizer, PegasusTokenizer)),
        (MBartConfig, (MBartTokenizer, MBartTokenizer)),
        (XLMRobertaConfig, (XLMRobertaTokenizer, XLMRobertaTokenizer)),
        (MarianConfig, (MarianTokenizer, None)),
        (BlenderbotConfig, (BlenderbotSmallTokenizer, None)),
        (LongformerConfig, (LongformerTokenizer, LongformerTokenizer)),
        (BartConfig, (BartTokenizer, BartTokenizer)),
        (LongformerConfig, (LongformerTokenizer, LongformerTokenizer)),
        (RobertaConfig, (BertweetTokenizer, None)),
        (RobertaConfig, (PhobertTokenizer, None)),
        (RobertaConfig, (RobertaTokenizer, RobertaTokenizer)),
        (ReformerConfig, (ReformerTokenizer, ReformerTokenizer)),
        (ElectraConfig, (ElectraTokenizer, ElectraTokenizer)),
        (FunnelConfig, (FunnelTokenizer, FunnelTokenizer)),
        (LxmertConfig, (LxmertTokenizer, LxmertTokenizer)),
        (LayoutLMConfig, (LayoutLMTokenizer, LayoutLMTokenizer)),
        (DPRConfig, (DPRQuestionEncoderTokenizer, DPRQuestionEncoderTokenizer)),
        (SqueezeBertConfig, (SqueezeBertTokenizer, SqueezeBertTokenizer)),
        (BertConfig, (BertTokenizer, BertTokenizer)),
        (OpenAIGPTConfig, (OpenAIGPTTokenizer, OpenAIGPTTokenizer)),
        (GPT2Config, (GPT2Tokenizer, GPT2Tokenizer)),
        (TransfoXLConfig, (TransfoXLTokenizer, None)),
        (XLNetConfig, (XLNetTokenizer, XLNetTokenizer)),
